    ...
    <section class="posts">
        <div class="container">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top1.png')}}" alt="Image" class="posts__img">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top2.png')}}" alt="Image" class="posts__img">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top3.png')}}" alt="Image" class="posts__img">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top4.png')}}" alt="Image" class="posts__img">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top5.png')}}" alt="Image" class="posts__img">
            ...
            <li class="posts__item">
                <a href="#">
                <img src="{{ asset ('assets/img/top6.png')}}" alt="Image" class="posts__img">
